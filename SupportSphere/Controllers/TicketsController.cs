...
namespace SupportSphere.Controllers
{
    public class TicketsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Title,Description,Priority,CategoryId,SubCategoryId")] Ticket ticket)
        {
            if (ModelState.IsValid)
            {
                ...
                ticket.CustomerId = User.Identity?.Name ?? "Customer";
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TicketId,TicketNumber,Title,Description,Status,Priority,CreatedDate,ResolvedDate,CategoryId,SubCategoryId,CustomerId")] Ticket ticket)
        {
